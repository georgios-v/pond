...
VOID_TASK_PROTO_4(compute_w_coefficients, int, n, int, a, int, b, COMPLEX*, W);
VOID_TASK_PROTO_6(unshuffle, int, a, int, b, COMPLEX*, in, COMPLEX*, out, int, r, int, m);
VOID_TASK_PROTO_9(fft_twiddle_gen, int, i, int, i1, COMPLEX*, in, COMPLEX*, out, COMPLEX*, W, int, nW, int, nWdn, int, r, int, m);
VOID_TASK_PROTO_8(fft_twiddle_2, int, a, int, b, COMPLEX*, in, COMPLEX*, out, COMPLEX*, W, int, nW, int, nWdn, int, m);
VOID_TASK_PROTO_5(fft_unshuffle_2, int, a, int, b, COMPLEX*, in, COMPLEX*, out, int, m);
VOID_TASK_PROTO_8(fft_twiddle_4, int, a, int, b, COMPLEX*, in, COMPLEX*, out, COMPLEX*, W, int, nW, int, nWdn, int, m);
VOID_TASK_PROTO_5(fft_unshuffle_4, int, a, int, b, COMPLEX*, in, COMPLEX*, out, int, m);
VOID_TASK_PROTO_8(fft_twiddle_8, int, a, int, b, COMPLEX*, in, COMPLEX*, out, COMPLEX*, W, int, nW, int, nWdn, int, m);
VOID_TASK_PROTO_5(fft_unshuffle_8, int, a, int, b, COMPLEX*, in, COMPLEX*, out, int, m);
VOID_TASK_PROTO_8(fft_twiddle_16, int, a, int, b, COMPLEX*, in, COMPLEX*, out, COMPLEX*, W, int, nW, int, nWdn, int, m);
VOID_TASK_PROTO_5(fft_unshuffle_16, int, a, int, b, COMPLEX*, in, COMPLEX*, out, int, m);
VOID_TASK_PROTO_8(fft_twiddle_32, int, a, int, b, COMPLEX*, in, COMPLEX*, out, COMPLEX*, W, int, nW, int, nWdn, int, m);
VOID_TASK_PROTO_5(fft_unshuffle_32, int, a, int, b, COMPLEX*, in, COMPLEX*, out, int, m);
VOID_TASK_PROTO_6(fft_aux, int, n, COMPLEX*, in, COMPLEX*, out, int*, factors, COMPLEX*, W, int, nW);
VOID_TASK_PROTO_3(fft_t, int, n, COMPLEX*, in, COMPLEX*, out);
...
//void fft_t(int n, COMPLEX * in, COMPLEX * out)

VOID_TASK_3(fft_t, int, n, COMPLEX*, in, COMPLEX*, out) {
...
//	print("\n %d -- %s %s \n", argc, argv[0], argv[1]);
	...
	int i;
	COMPLEX *in, *out1, *out2 = NULL;
	in = (COMPLEX*) malloc(bots_arg_size * sizeof (COMPLEX));
	bots_set_info("FFT", false);
	...
	bots_t_start = bots_usecs();
	ROOT_CALL(fft_t, bots_arg_size, in, out1);
	bots_t_end = bots_usecs();
