 ...
 *
\****************************************************************************/
static const char *ident __attribute__((__unused__)) = "$HeadURL: https://bradley.csail.mit.edu/svn/repos/cilk/5.4.3/examples/lu.cilk $ $LastChangedBy: sukhaj $ $Rev: 517 $ $Date: 2003-10-27 10:05:37 -0500 (Mon, 27 Oct 2003) $";
 ...
 */
int lu(APP_ARGS);
VOID_TASK_PROTO_4(schur, Matrix, M, Matrix, V, Matrix, W, int, nb);
VOID_TASK_PROTO_4(aux_lower_solve, Matrix, Ma, Matrix, Mb, Matrix, L, int, nb);
VOID_TASK_PROTO_3(lower_solve, Matrix, M, Matrix, L, int, nb);
VOID_TASK_PROTO_4(aux_upper_solve, Matrix, Ma, Matrix, Mb, Matrix, U, int, nb);
VOID_TASK_PROTO_3(upper_solve, Matrix, M, Matrix, U, int, nb);
VOID_TASK_PROTO_2(lu_par, Matrix, M, int, nb);
...
VOID_TASK_3(lower_solve, Matrix, M, Matrix, L, int, nb) {
	...
	CALL(aux_lower_solve, M00, M10, L, hnb);
...
VOID_TASK_3(upper_solve,Matrix, M, Matrix, U, int, nb) {
	...
	CALL(aux_upper_solve, M00, M01, U, hnb);
...
/*
 * lu_par - Perform LU decomposition of matrix M.
 */

VOID_TASK_2(lu_par,Matrix, M, int, nb) {
	Matrix M00, M01, M10, M11;
	int hnb;
...
static int invalid_input(int n) {
	int v = n;
